...
export const IconGrid = svg(<><rect x="3.5" y="3.5" width="7" height="7" rx="1.5" /><rect x="13.5" y="3.5" width="7" height="7" rx="1.5" /><rect x="3.5" y="13.5" width="7" height="7" rx="1.5" /><rect x="13.5" y="13.5" width="7" height="7" rx="1.5" /></>)
...
export const IconInbox = svg(<><path d="M3 12h4l1.5 3h7L17 12h4" /><path d="M4.6 5.5 3 12v6a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-6l-1.6-6.5A2 2 0 0 0 17.5 4h-11a2 2 0 0 0-1.9 1.5Z" /></>)
